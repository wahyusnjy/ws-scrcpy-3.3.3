...
export class ControlMessage {
    public static TYPE_INJECT_KEYCODE = 0; // Standard Android keycode injection (for Back, Home, etc.)
    public static TYPE_KEYCODE = 100; // UHID keyboard (for physical keyboard input)
